        ...
        <div class="dv-dangnhap">
           <!--  -->
            ...
            <div class="dangnhap_popup no_box">
                ...
                <div class=" row-frm">
                    <a href="<?=$full_url."/tai-khoan/" ?>" class=" dk_dangnhap_1 quenmatkhau cur"><?=$glo_lang['thong_tin_tai_khoan'] ?></a>
                </div>
                <div class="box_dangnhap_popup"><a class="cur" onClick="return check_capnhat()"><?=$glo_lang['luu_thay_doi'] ?> <img class="img_load_from_dktv" src="images/loading2.gif"></a>
                </div>
                <div class="clr"></div>
              </div>
            </form>
