...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="BANG DOT VN")
{
      ...
      $smtp_host ='smtp.bang.vn';
      $admin_email = 'smtp@bang.vn';
      $smtp_username = 'smtp@bang.vn';
      $smtp_password = 'da74^186#7d623';
      $result = @smtpmail($tomail,$subject,$message,$headers,$smtp_host, $smtp_username, $smtp_password,$admin_email);

}
//Test send mail
//SendMail("ky@bang.vn","chaukysky@yahoo.com","Details of Booking Form","Content Testing");
