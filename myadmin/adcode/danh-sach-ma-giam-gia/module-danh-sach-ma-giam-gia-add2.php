              ...
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="form-group">
                  ...
                  <div class="dv-grup-lable">
                    <div class="dv-gr-lb">
                      <input type="number" name="so_lan_su_dung" id="so_lan_su_dung" value="1">
                      <label>
            ...
            <div class="box p10">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input name="bat_dau" type="text" class="form-control datepicker pull-right" id="datepicker2" value='<?=!empty($bat_dau) ? SHOW_text($bat_dau) : date("d/m/Y", time()) ?>'>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input name="ket_thuc" type="text" class="form-control pull-right" id="datepicker3" value='<?=!empty($ket_thuc) ? SHOW_text($ket_thuc) : date("d/m/Y", time()+5*24*60*60) ?>'>
                </div>
              </div>
            </div>
            <div class="box p10">
              <div class="form-group">
                ...
                <div class="dv-magiamgia-nhom dv-magiamgia-nhom-1" style="display: block">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control"  name="mgg_soluong" value="1">
                  </div>
                </div>
