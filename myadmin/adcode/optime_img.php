<?php 
    class TinyPNG 
  {
      // API Endpoint https://tinypng.com/developers
          ...
          if ($input !== null) {
              ...
              if (is_array($input)) {
                  ...
                  if ($output !== null) {
                      ...
                      return 0;//"Invalid output path provided.";
                  }
              }
          } else {
              return 0;//"Invalid input path provided.";
          }
      }
      ...
      private function compressImage($input, $output)
      {
          ...
          if (curl_getinfo($this->curl, CURLINFO_HTTP_CODE) === 201) {
              ...
              return 0;//"Sorry, an unexpected error has occurred.";
          } else {
  ...
  function opt_images($str, $str_out, $key)
  {
      // $tinypng = new TinyPNG("WH7Pw44SQM3VnH7DZPwzh7DC64Qnc3F1");
      $tinypng = new TinyPNG($key);

      return $tinypng->compress($str, $str_out);
