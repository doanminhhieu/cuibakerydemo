...
<div class="box p10">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="gia_tri_2_vi" value="<?=!empty($gia_tri_2_vi) ? Show_text($gia_tri_2_vi) : "" ?>">
  </div>
  <input type="hidden" class="form-control" name="seo_name" value="[no_seo_name]">
  <!-- <div class="form-group" style="display: none">
