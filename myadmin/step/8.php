...
<div class="box p10">
  ...
  <div class="form-group">
    <label>Link Video <a data-tooltip="Double click vào input để chọn file đã upload. Hoặc chèn link youtube dạng https://www.youtube.com/watch?v=eKzG6QoXFdU" > </a></label>
